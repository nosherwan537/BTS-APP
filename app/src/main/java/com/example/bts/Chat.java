...
public class Chat extends AppCompatActivity {
    ...
    void callApi(JSONObject jsonObject){
        ...
        Request request = new Request.Builder()
                .url(url)
                .post(body)
                .header("Authorization","Bearer AAAAbrXUtcE:APA91bFnp6Dz0gbR87Kk725YQW-hLsnnX8RraqgqHnsvQjiQxWFImLMlOiHwe0sML2vfPKwRIBUq5qBpN-xWH1xGebfDEyHggCNcf79B_xa-pdL5wdCQ74XCIXAG11Zft1CQVLbeUCXj")
                .build();
